    ...
    public function store(Request $request)
    {
        ...
        try {
            $validatedData = $request->validate([
                ...
                'course_paths.*.duration' => 'nullable|numeric|max:255',
                ...
                'path_of_paths.*.*.duration' => 'nullable|numeric|max:255',
            ]);
            ...
            return back()->withErrors($e->errors())->withInput()->with('error', 'Please fix the errors.');
        }
        ...
        try {
            ...
            if ($request->has('course_paths') || $request->has('path_of_paths')) {
