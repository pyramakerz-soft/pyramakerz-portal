...
<body class="body__wrapper">
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="lesson__content__main">
                            ...
                            <div id="lesson-video" class="video-container">
                                @if (!empty($lessons[0]['materials']))
                                    @foreach ($lessons[0]['materials'] as $material)
                                        @if ($material->type == 'video')
                                            <iframe src="{{ $material->url }}" allowfullscreen allow="autoplay"></iframe>
                                            @break
                                        @endif
                                    @endforeach
                                @else
    ...
    <script>
        ...
        function selectLesson(index, title, videoUrl, startTime, endTime) {
            ...
            // Stop previous countdown and start new one
