...
<body class="body__wrapper">
    ...
    <main class="main_wrapper overflow-hidden">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-12" data-aos="fade-up">
                        <div class="educationarea__wrapper">
                            ...
                            <div class="educationarea__heading">
                                <h2>ALPHA Generation </h2>
                                <h5 class="primary">Powered By Pyramakerz </h5>

                            </div>
                            <div class="educationarea__content">
                                <p>The Four-Year Scholarship Program prepares students for a future-ready career by
                                    equipping them with essential
                                    skills and confidence needed in today’s job market, focusing on four critical
                                    domains. </p>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-12" data-aos="fade-up">
                        <div class="educationarea__right__wraper" data-tilt>
                            <div class="educationarea__img">
                                <img loading="lazy" class="education__img__1 round" src="img/about/7.png"
                                    alt="education" style="height: 450px;">
                                ...
                                <img loading="lazy" class="education__img__3" src="img/education/education__2.png"
                                    alt="education">
                                <img loading="lazy" class="education__img__4" src="img/education/education__3.png"
                                    alt="education">
                            </div>
                            <div class="educationarea__small__img">
                                <a href="#">
                                    <img loading="lazy" class="education__img__5" src="img/education/education__4.png"
                                        alt="education">
                                    <img loading="lazy" class="education__img__6" src="img/education/education__5.png"
                                        alt="education">
                                    <img loading="lazy" class="education__img__7" src="img/education/education__6.png"
                                        alt="education">
                                    <img loading="lazy" class="education__img__8" src="img/education/education__7.png"
                                        alt="education">
                                </a>

                                <div class="educationarea__small__para">
                                    <p> over <span>200+</span> Qualified Trainers</p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 ">
                                <div class="brandarea__img">
                                    <img loading="lazy" src="img/logo/pyramakerz.png" style="height: 100px;"
                                        alt="brand">
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 ">
                                <div class="brandarea__img">
                                    <img loading="lazy" src="img/logo/labinah.png" alt="brand"
                                        style="height: 100px;">
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 ">
                                <div class="brandarea__img">
                                    <img loading="lazy" src="img/logo/amber.png" alt="brand"
                                        style="height: 100px;">
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 ">
                                <div class="brandarea__img">
                                    <img loading="lazy" src="img/logo/stem.png" alt="brand"
                                        style="height: 100px;">
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 ">
                                <div class="brandarea__img">
                                    <img loading="lazy" src="img/logo/robota.png" alt="brand"
                                        style="height: 100px;">
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-6 ">
                                <div class="brandarea__img">
                                    <img loading="lazy" src="img/logo/edsimz.png" alt="brand"
                                        style="height: 80px;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="trainingarea__wraper">
                            <div class="trainingarea__icon">
                                <i class="icofont-book-alt"></i>
                                <div class="trainingarea__content">
                                    <h6><a href="#">Artificial Intelligence
                                        </a></h6>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-12 ">
                        <div class="aboutarea__content__wraper">
                            ...
                            <div class="aboutarea__para">
                                <p>The E.P.A Diploma is designed to provide students with a dynamic and immersive
                                    learning experience, combining practical, project-based activities with a
                                    comprehensive curriculum. With a team of highly qualified trainers and a
                                    cutting-edge learning management system, the program ensures personalized
                                    instruction
                                    and seamless content delivery across various domains, including programming,
                                    robotics, game development,AI , Soft Skills, and entrepreneurship.
                                </p>
                            </div>
                            <div class="aboutarea__list">
                                <ul>
                                    <li>
                                        <i class="icofont-check"></i> Hands-on Learning
                                    </li>

                                    <br>
                                    <li>
                                        <i class="icofont-check"></i> Experienced Trainers
                                    </li>
                                    <br>
                                    <li>
                                        <i class="icofont-check"></i> Robust Learning Platform
                                    </li>
                                    <br>

                                    <li>
                                        <i class="icofont-check"></i> Comprehensive Curriculum
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="populerarea__2 sp_top_50 sp_bottom_50">
            <div class="container-fluid full__width__padding">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 about__wrap__content" data-aos="fade-up">
                        <div class="populerarea__content__wraper__2">
                            ...
                            <div class="populerarea__content__2">
                                <!-- <p class="populerarea__para__2">
                                Empowering students with future-ready skills through innovative, inclusive, and flexible learning, preparing them for modern careers, freelancing, entrepreneurship, and remote work in the 21st-century labor market.                                </p>
                                <p class="populerarea__para__2">
                                Equipping students with the skills and experiences essential for meeting the demands of the 21st-century labor market.
                                </p>
                                <p class="populerarea__para__2">
                                Igniting students' enthusiasm for contemporary career paths and equip them with skills in freelancing, marketing, Entrepreneurship, and remote work.                                </p>
                                <p class="populerarea__para__2">
                                Creating an inclusive learning environment with innovative teaching and digital resources ensures quality education that transcends geographical barriers and supports all students in a changing world.
                                </p> -->
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 service__wrap__content">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service">
                                    <div class="service__img">
                                        <img loading="lazy" src="img/icon/chat-app.png" alt="">

                                    </div>
                                    <div class="service__content service__content__2">
                                        <h3>AI & Code Quest:
                                            Foundations of Creativity </h3>

                                        <ul>
                                            <li> <i class="icofont-check"></i>Programming Universe (8 sessions)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>AI Foundations (8)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>App Inventor (8)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Roblox builder (10)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Creative Communication (3)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Teamwork & Collaboration (3)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Young Entrepreneurs (4)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Problem-Solving Workshops (4)</li>
                                        </ul>
                                ...
                                <div class="single__service">
                                    <div class="service__img">
                                        <img loading="lazy" src="img/icon/machine-learning.png" alt="">
                                    </div>
                                    <div class="service__content service__content__2">
                                        <h3>AI Innovators: Mastering the Digital Realm</h3>

                                        <p>
                                        <ul>
                                            <li> <i class="icofont-check"></i> Cybersecurity (12 sessions)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>LogicMatrix (9)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>DataVision (12)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Algorithms (3)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Mobile dev Level 1 (4)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Agile Project Management Mastery(3)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Innovative Marketing & Creative
                                                Strategies for Growth (3)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Entrepreneurial Projects (4)</li>
                                        </ul>
                                        </p>
                                    </div>
                                    <div class="service__button">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service ss_margin">
                                    <div class="service__img">
                                        <img loading="lazy" src="img/icon/virtual-reality.png" alt="">
                                    ...
                                    <div class="service__content service__content__2">
                                        ...
                                        <p>
                                        <ul>
                                            <li> <i class="icofont-check"></i>Web Sage (8 sessions)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Python & AI Level 1 (8)

                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Python & AI Level 2 (8)

                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>DataForge (9)

                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Emotional intelligence(3)

                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Leadership Skills (3)

                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Entrepreneurial Thinking (4)

                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Time Management Techniques(3)</li>
                                        </ul>
                                        </p>
                                    </div>
                                ...
                                <div class="single__service">
                                    <div class="service__img">
                                        <img loading="lazy" src="img/icon/artificial-intelligence.png"
                                            alt="">
                                    ...
                                    <div class="service__content service__content__2">
                                        ...
                                        <h3>AI Architects:
                                            Building the Future </h3>
                                        <p>
                                        <ul>
                                            <li> <i class="icofont-check"></i> Advanced AI (9 sessions)</li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Databases (8)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Mobile Dev level 2 (8)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Mobile dev Level 3 (9)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Personal Branding Strategies (4)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Freelancing Essentials (3)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Job Application Techniques (3)
                                            </li>
                                            <br>
                                            <li> <i class="icofont-check"></i>Entrepreneurial Ventures (4)</li>
                                        </ul>
                                        </p>
                                    </div>
                ...
                <div class="timeline">
                    ...
                    <div class="containr right-container">
                        ...
                        <div class="text-box">
                            <h2> College</h2>
                            Mentorship:
                            <p>Guidance from seasoned professionals in your field.</p>
                    ...
                    <div class="containr right-container">
                        ...
                        <div class="text-box">
                            ...
                            <p>Guidance from industry experts and business mentors to develop and refine ideas.<br>
                                Access to resources for prototype development and market validation.<br>
                                $20,000 USD investment for winning startup ideas to kickstart their ventures.</p>
                            <span class="right-container-arrow"></span>
                        </div>
                    ...
                    <div class="containr left-container">
                        ...
                        <div class="text-box">
                            ...
                            <p>Encourages innovation and entrepreneurial thinking among graduates.<br>
                                Contributes to the growth of the tech startup ecosystem.<br>
                                Provides partners with early access to promising startups and potential collaborations.
                            </p>
                            <span class="left-container-arrow"></span>
                        </div>
                ...
                <div class="animate__content__wrap">
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Expert-Led Training
                                    (600 Hours)</a></h3>
                            <p>Receive comprehensive instruction from seasoned professionals and earn a Diploma that
                                boosts your marketability.</p>
                        </div>
                        <div class="service__small__img">
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Professional Networking</a></h3>
                            <p>Connect with peers, mentors, and industry experts to build a strong support system and
                                expand career opportunities.</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3>Leadership and
                                Confidence</h3>
                            <p>Develop the skills and mindset needed to excel in tech roles or launch your own
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.html">Programming and AI Expertise Confidence</a></h3>
                            <p>Gain in-demand technical skills, from coding fundamentals to advanced artificial
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            ...
                            <p>Hone critical thinking, teamwork, communication, and project management skills crucial
                                for success in any field.</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3>Versatile Career Pathways</h3>
                            <p>Prepare to pursue various professional avenues, including freelancing, international
                                collaborations, and leadership roles.</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3>Continuous Learning and Adaptability Confidence</h3>
                            <p>Cultivate the ability to stay ahead of industry trends and adapt to the fast-paced world
                                of technology.</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="herobannerarea herobannerarea__2 herobannerarea__clms">
            <div class="container">
                <div class="row">
                        ...
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__title">
                                ...
                                <div class="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                                    <h2>Our Competition Program</h2>
                                </div>
                            </div>


                            <div class="herobannerarea__text herobannerarea__text__2">
                                <p>To foster creativity, teamwork, and technical expertise among students.</p>
                            </div>

                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-8 col-sm-12 col-12" data-aos="fade-up">

                        <div class="swiper hero__course">
                            <div class="swiper-wrapper">

                                <div class="swiper-slide gridarea__wraper gridarea__wraper__2">
                                    <div class="gridarea__img">
                                        <img loading="lazy" src="img/ai_6.jpg" alt="grid">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <p>Open to individuals and teams of students enrolled in the diploma
                                            program.<br>
                                            Challenges include solving real-world problems using programming, AI, and
                                            entrepreneurial skills.<br>
                                            Final event includes project showcases and presentations judged by industry
                                            leaders.</p>
                                ...
                                <div class="swiper-slide gridarea__wraper gridarea__wraper__2">
                                    <div class="gridarea__img">
                                        <img loading="lazy" src="img/ai_5.jpg" alt="grid">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <p>
                                            Open to individuals and teams of students enrolled in the diploma
                                            program.<br>
                                            Challenges include solving real-world problems using programming, AI, and
                                            entrepreneurial skills.<br>
                                            Final event includes project showcases and presentations judged by industry
                                ...
                                <div class="swiper-slide gridarea__wraper gridarea__wraper__2">
                                    <div class="gridarea__img">
                                        <img loading="lazy" src="img/ai_7.jpg" alt="grid">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <p>Branding and visibility as competition sponsors or judges.

                                            Direct engagement with emerging talent in the tech field.

                                            Access to innovative ideas and solutions presented during the competition.
                                        </p>
                    ...
                    <div class="herobannerarea__icon__2">
                        ...
                        {{-- <img loading="lazy" class="herobanner__common__img herobanner__img__4"
                            src="img/herobanner/herobanner__4.png" alt="photo"> --}}
