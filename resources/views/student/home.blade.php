                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-12" data-aos="fade-up">
                        <div class="educationarea__wrapper">
                            ...
                            <div class="educationarea__heading">
                                <h2>Cultivating Excellence </h2>
                            </div>
                            <div class="educationarea__content">
                                <p>Nurturing talents to reach new heights,with 6+ years of leading in EdTech. </p>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-12" data-aos="fade-up">
                        <div class="educationarea__right__wraper" data-tilt>
                            <div class="educationarea__img">
                                <img loading="lazy" class="education__img__1 round" src="img/ai_6.jpg" alt="education">
        ...
        <div class="eventlistarea sp_top_50 sp_bottom_100">
            ...
            <div class="container">
                <div class="eventlistarea__bg">
                    <svg width="938" height="919" viewBox="0 0 938 919" fill="none"
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_141_3" x1="621.24" y1="112.617" x2="328.645"
                                y2="881.586" gradientUnits="userSpaceOnUse">
                        ...
                        <ul class="nav  tab__button__wrap" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link active" data-bs-toggle="tab"
                                    data-bs-target="#projects__one" type="button">Monday</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link" data-bs-toggle="tab"
                                    data-bs-target="#projects__two" type="button">Tuesday</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link" data-bs-toggle="tab"
                                    data-bs-target="#projects__three" type="button">Wednesday</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link" data-bs-toggle="tab"
                                    data-bs-target="#projects__four" type="button">Thursday</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link" data-bs-toggle="tab"
                                    data-bs-target="#projects__five" type="button">Friday</button>
                            </li>
                ...
                <div class="tab-content tab__content__wrapper" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="projects__five" role="tabpanel"
                ...
                <div class="row">
                    <div class="brandarea__wraper" data-aos="fade-up">
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_1.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_2.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_3.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_4.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_5.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_6.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_7.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_8.png"
                                    alt="brand"></a>
                        </div>
                        <div class="brandarea__img">
                            <a href="#"><img loading="lazy" src="img/brand/brand_9.png"
                                    alt="brand"></a>
                        </div>
                    </div>
                </div>
