                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="course__details__top--2">
                            ...
                            <div class="course__details__heading" data-aos="fade-up">
                                ...
                                <a class="btn btn-info btn-sm" href="{{ route('instructor.groups', $course->id) }}">
                                            ...
                                            <div class="course__summery__item">
                                                ...
                                                <span class="sb_content">
                                                    @if($course->instructor)
                                                        ...
                                                        <button class="btn btn-sm btn-outline-warning assign-teacher-btn" data-course-id="{{ $course->id }}" style="border: none;">
                                                            Change Instructor
                                                        </button>
                                                    @else
                                                        <button class="btn btn-sm btn-outline-success assign-teacher-btn" data-course-id="{{ $course->id }}" style="border: none;">
                                                            + Assign Instructor
                                                        </button>
                                                    @endif
                                                </span>
