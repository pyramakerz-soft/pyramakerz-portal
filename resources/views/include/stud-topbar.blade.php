                    ...
                    <div class="dashboardarea__inner student__dashboard__inner">
                        <div class="dashboardarea__left">
                            <div class="dashboardarea__left__img">
                                <img loading="lazy" src="{{ Auth::guard('student')->user() ? asset(Auth::guard('student')->user()->photo) : asset('student_photos/user.jpeg') }}" alt="User Photo">
                    ...
                    fetch('{{ route('ticket.store') }}', {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                Swal.fire('Error!', 'There was an error submitting your ticket',
                                    'error');
                            }
                        })
                        .catch(error => {
