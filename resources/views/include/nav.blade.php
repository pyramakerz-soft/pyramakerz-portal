                            ...
                            <ul>
                                ...
                                <li class="mega__menu position-static">
                                    ...
                                    <div class="headerarea__submenu mega__menu__wrapper">
                                        ...
                                        <div class="row">
                                            <div class="col-3 mega__menu__single__wrap">
                                                <h4 class="mega__menu__title"><a href="#">Get Started 1
                                                    </a></h4>
                                            ...
                                            <div class="col-3 mega__menu__single__wrap">
                                                <h4 class="mega__menu__title"><a href="#">Get Started 2
                                                    </a></h4>
                                                <ul class="mega__menu__item">
                                            ...
                                            <div class="col-3 mega__menu__single__wrap">
                                                <h4 class="mega__menu__title"><a href="#">Get Started
                                                        3</a></h4>
                                                <ul class="mega__menu__item">
                                                    ...
                                                    <li><a href="maintenance-dark.html">Maintenance Dark</a>
                                                    </li>
                                    ...
                                    <ul class="headerarea__submenu headerarea__submenu--third--wrap">
                                        <li><a href="../admin-dashboard.html">Admin <i
                                            ...
                                            <ul class="headerarea__submenu--third">
                                                <li><a href="dashboard/admin-dashboard.html">Admin
                                                        Dashboard</a></li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="headerarea__submenu--third">
                                                ...
                                                <li><a href="dashboard/instructor-profile.html">Inst.
                                                        Profile</a></li>
                                                <li><a href="dashboard/instructor-message.html">Message</a>
                                                </li>
                    ...
                    <div class="headerarea__right">
                        ...
                        <div class="headerarea__button">
                            @if( Auth::guard('admin')->user())
                                <a href="{{ route('admin-courses') }}">Hello, {{ Auth::guard('admin')->user()->name}}</a>
                            @else
