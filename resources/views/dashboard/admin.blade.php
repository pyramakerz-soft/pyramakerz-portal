                                ...
                                <div class="dashboard__content__wraper admin__content__wrapper">
                                    ...
                                    <div class="dashboard__recent__course">
                                        <div class="dashboard__recent__course__single">
                                            ...
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                                    <h3><a href="../course-details.html"> Complete Python Zero to Hero
                                                            in Python.</a></h3>
                                                </div>
                                        ...
                                        <div class="dashboard__recent__course__single">
                                            ...
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                                    <h3><a href="../course-details.html"> Lorem ipsum dolor sit amet
                                                            consectetur.</a></h3>
                                                </div>
                                                <div class="dashboard__recent__course__meta">
                                                    <ul>
                                        ...
                                        <div class="dashboard__recent__course__single">
                                            ...
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                                    <h3><a href="../course-details.html">Voluptatum eius quo
                                                            consectetur atque.</a></h3>
                                                </div>
                                                <div class="dashboard__recent__course__meta">
                                                    <ul>
                                                        <li>
                                        ...
                                        <div class="dashboard__recent__course__single">
                                            ...
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                                    <h3><a href="../course-details.html"> Sapiente recusandae nemo sint
                                                            hic iste!</a></h3>
                                                </div>
                                                <div class="dashboard__recent__course__meta">
                                                    <ul>
                                    ...
                                    <div class="dashboard__recent__course dashboard__notice__board">
                                        <div class="dashboard__recent__course__single">
                                            ...
                                            <div class="dashboard__recent__course__content">
                                                <div class="dashboard__recent__course__heading">
                                                    <h3><a href="../course-details.html"> Lorem ipsum dolor sit amet
                                                            consectetur adipisicing elit. Libero velit quos dolore
                                                            voluptatem...</a></h3>
                                                </div>
