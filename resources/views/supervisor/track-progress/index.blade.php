                                            ...
                                            <div class="counterarea__text__wraper">
                                                ...
                                                <div class="counter__content__wraper">
                                                    <div class="counter__number">
                                                        <p class="counter"><strong>Total Groups:</strong> {{ $totalGroups }}</p>
                                                        <br>
                                                        <p class="counter"><strong>Online Groups:</strong> {{ $onlineGroups }}</p>
                                                        <br>
                                                        <p class="counter"><strong>Offline Groups:</strong> {{ $offlineGroups }}</p>
                                                    </div>
                                            ...
                                            <div class="counterarea__text__wraper">
                                                ...
                                                <div class="counter__content__wraper">
                                                    <div class="counter__number">
                                                        ...
                                                        <p class="counter"><strong>Delayed Groups:</strong> {{ $delayedGroups }}</p>
                                                        <br>
                                                        <p class="counter"><strong>Finished Groups:</strong> {{ $finishedGroups }}</p>
                                                        <br>
                                                        <p class="counter"><strong>Canceled Groups:</strong> {{ $canceledGroups }}</p>
                                                    </div>
