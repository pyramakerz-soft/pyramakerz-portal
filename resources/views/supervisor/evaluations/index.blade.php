    ...
    <script>
        $(document).ready(function() {
            $(".view-comments-btn").click(function() {
                ...
                $.get("{{ route('admin.instructors.viewEvalComments', ['id' => '__ID__']) }}".replace('__ID__', evaluationId), function(comments) {
                    let commentsHtml = comments.length ? "" : "<p style='color:black;'>No comments submitted.</p>";

                    comments.forEach(comment => {
                        commentsHtml += `<div class="comment-box">
                    <strong>${comment.criteria}</strong><br>
                    ${comment.comment}
