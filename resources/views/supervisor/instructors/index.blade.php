                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $instructor->courses->pluck('name')->join(', ') ?: 'No Courses' }}</td>
                                        <td>
                                            <button class="btn btn-sm btn-warning comment-btn" data-instructor-id="{{ $instructor->id }}">
                                                <i class="icofont-comment"></i> Comment
                                            </button>
                                            <a href="{{ route('admin.evaluations.index', ['instructor_id' => $instructor->id]) }}" class="btn btn-sm btn-info">
                                                <i class="icofont-chart-histogram"></i> Evaluation
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post("{{ route('admin.instructors.comment') }}", {
                            ...
                            Swal.fire("Success", "Comment added!", "success").then(() => location.reload());
                        }).fail(() => {
